...
if ( is_user_logged_in() ) {
    ...
    $post_contents = $post_contents.
        ...
        <form  action="redirect-to-meet.php" method="post"><input type="hidden" value="'.get_permalink($post_id).'" name="postLink" /><input type="hidden" value="'.$meetingID.'" name="meetingID" /><input type="hidden" value="'.$event_mader.'" name="mader" /><button id="joinbutton" name="redirect_submit" value="redirect"></button></form>';
