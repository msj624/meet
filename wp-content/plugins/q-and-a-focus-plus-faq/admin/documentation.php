...
<p><strong><?php _e('Enable excerpts', 'qa-focus-plus'); ?></strong>: <code>[qafp excerpts=true]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa excerpts=true]</code>. <?php _e('Whether to limit posts length on the homepage. Entries that are longer than 40 words will be shorted and a &#8220;Continue reading&#8221; link will be added. Possible values are', 'qa-focus-plus'); ?> <strong><?php _e('true', 'qa-focus-plus'); ?></strong> <?php _e('or', 'qa-focus-plus'); ?> <strong><?php _e('false', 'qa-focus-plus'); ?></strong>.</p>
...
<p><strong><?php _e('Search', 'qa-focus-plus'); ?></strong>: <code>[qafp search=home]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa search=home]</code>. <?php _e('Whether to show the search field. Possible values are', 'qa-focus-plus'); ?> <strong><?php _e('home', 'qa-focus-plus'); ?></strong>, <strong><?php _e('categories', 'qa-focus-plus'); ?></strong>, <strong><?php _e('both', 'qa-focus-plus'); ?></strong>, <?php _e('or', 'qa-focus-plus'); ?> <strong><?php _e('none', 'qa-focus-plus'); ?></strong> <?php _e('to disable the search field.', 'qa-focus-plus'); ?></p>

<p><strong><?php _e('Search position', 'qa-focus-plus'); ?></strong>: <code>[qafp searchpos=top]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa searchpos=top]</code>. <?php _e('Position of the search box, if enabled. Possible values are', 'qa-focus-plus'); ?> <strong><?php _e('top', 'qa-focus-plus'); ?></strong> <?php _e('or', 'qa-focus-plus'); ?> <strong><?php _e('bottom', 'qa-focus-plus'); ?></strong>.</p>

<p><strong><?php _e('Permalinks', 'qa-focus-plus'); ?></strong>: <code>[qafp permalinks=true]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa permalinks=true]</code>. <?php _e('Whether to show permalinks for individual FAQs. This makes it easier for users to click through and bookmark your content. Possible values are', 'qa-focus-plus'); ?> <strong><?php _e('true', 'qa-focus-plus'); ?></strong> <?php _e('or', 'qa-focus-plus'); ?> <strong><?php _e('false', 'qa-focus-plus'); ?></strong>.</p>

<p><strong><?php _e('Animation', 'qa-focus-plus'); ?></strong>: <code>[qafp animation=fade]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa animation=fade]</code>. <?php _e('Customize the animation style when opening and closing FAQs. Possible values are', 'qa-focus-plus'); ?> <strong><?php _e('fade', 'qa-focus-plus'); ?></strong> <strong><?php _e('slide', 'qa-focus-plus'); ?></strong>, <?php _e('and', 'qa-focus-plus'); ?> <strong><?php _e('none', 'qa-focus-plus'); ?></strong>.</p>

<p><strong><?php _e('Accordion', 'qa-focus-plus'); ?></strong>: <code>[qafp accordion=true]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa accordion=true]</code>. <?php _e('Clicking on one FAQ entry closes any other open FAQ entries on the page. Setting this to', 'qa-focus-plus'); ?> <strong><?php _e('false', 'qa-focus-plus'); ?></strong> <?php _e('will allow multiple FAQs to be open and visible on the page at the same time.', 'qa-focus-plus'); ?></p>

<p><strong><?php _e('Collapsible', 'qa-focus-plus'); ?></strong>: <code>[qafp collapsible=true]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa collapsible=true]</code>. <?php _e('You can completely disable the show/hide behavior by setting this to', 'qa-focus-plus'); ?> <strong><?php _e('false', 'qa-focus-plus'); ?></strong>.</p>

<p><strong><?php _e('Focus', 'qa-focus-plus'); ?></strong>: <code>[qafp focus=true]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa focus=true]</code>. <?php _e('Adds a link anchor behavior. When set to', 'qa-focus-plus'); ?> <strong><?php _e('true', 'qa-focus-plus'); ?></strong>, <?php _e('the current question will jump to the top of the browser window. You can completely disable the focus behavior by setting this to', 'qa-focus-plus'); ?> <strong><?php _e('false', 'qa-focus-plus'); ?></strong>.</p>

<p><strong><?php _e('Horizontal Rule', 'qa-focus-plus'); ?></strong>: <code>[qafp hr=true]</code> <?php _e('and', 'qa-focus-plus'); ?> <code>[qa hr=true]</code>. <?php _e('Adds a horizontal rule after each answer. You can completely disable the horizontal rule by setting this to', 'qa-focus-plus'); ?> <strong><?php _e('false', 'qa-focus-plus'); ?></strong>.</p>
...
<p><?php _e('If you are already using a plugin that adds post tag taxonomy support for custom post types, you can disable the built-in support by checking the &#8220;Disable built-in tag support&#8221; option. If you don#8217;t have any other custom post type taxonomy support enabled, disabling the built-in taxonomy support will break any tags that you have added to your FAQs. Broken tags will produce &#8220;nothing found&#8221; or other errors when clicked on. If checking the &#8220;Disable built-in tag support&#8221; option breaks your FAQ tags you will need to uncheck it. This option will be automatically disabled if you are using our', 'qa-focus-plus'); ?> <a href="http://spectrumvisions.com/plugins/wordpress/easy-taxonomy-support" target="_blank"><?php _e('Easy Taxonomy Support plugin', 'qa-focus-plus'); ?></a>.</p>

<p><?php _e('You can also hide the tags so that they do not appear on your FAQs. Tags should be hidden if you don#8217;t have any other taxonomy support and your tags are producing &#8220;nothing found&#8221; errors.', 'qa-focus-plus'); ?></p>