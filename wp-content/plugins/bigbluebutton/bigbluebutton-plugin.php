...
function bigbluebutton_sidebar($args) {
    ...
    echo $before_widget;
    echo $before_title.'KT-Conference'.$after_title;
    echo $after_widget;
...
function bigbluebutton_general_settings() {
    ...
    $out .= '<div class="wrap">';
    $out .= "<h2>KT-Conference General Settings</h2>";
    ...
    if($url_val == "http://test-install.blindsidenetworks.com/bigbluebutton/" ){
        $out .= '<div class="updated"><p><strong>You are using a test KT-Conference server provided by <a href="http://blindsidenetworks.com/" target="_blank">Blindside Networks</a>. </strong></div>';
    }
    //Form to update the url of the bigbluebutton server, and it`s salt

    $out .= '
    <form name="form1" method="post" action="">
    <p>URL of KT-Conference server:<input type="text" name="bigbluebutton_url" value="'.$url_val.'" size="60"> eg. \'http://test-install.blindsidenetworks.com/bigbluebutton/\'
    </p>
    <p>Salt of KT-Conference server:<input type="text" name="bigbluebutton_salt" value="'.$salt_val.'" size="40"> It can be found in /var/lib/tomcat6/webapps/bigbluebutton/WEB-INF/classes/bigbluebutton.properties. eg. \'8cd8ef52e8e101574e400365b55e11a6\'.
    </p>
...
function bigbluebutton_permission_settings() {
    ...
    //Displays the title of the page
    $out .= "<h2>KT-Conference Permission Settings</h2>";
