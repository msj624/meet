...
?>
	<div class="lwa lwa-default"><?php //class must be here, and if this is a template, class name should be that of template directory ?>
            ...
            <table>
                ...
                <tr class="lwa-submit">
                    ...
                    <td class="lwa-submit-links">
						...
						<br />
						<a href="<?php echo esc_attr(LoginWithAjax::$url_register); ?>"><?php esc_html_e('Register','login-with-ajax') ?></a>
                        <?php endif; ?>
                    </td>
                </tr>
            </table>
		...
		<div class="lwa-register lwa-register-default lwa-modal" style="display:none;">
			...
			<p><em class="lwa-register-tip"><?php esc_html_e('Your account will be reviewed by an administrator and you will be notified when it is activated.','login-with-ajax') ?></em></p>
