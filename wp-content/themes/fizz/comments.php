...
<section id="respond" class="respond-form">
	...
	<?php else : ?>
		...
		<li>
		  <label for="author"><?php _e("Name ", "site5framework"); ?></label>
		...
		<li>
		  <label for="email"><?php _e("Email ", "site5framework"); ?></label>
		...
		<li>
		  <label for="url"><?php _e("Website ", "site5framework"); ?></label>
	...
	<?php endif; ?>
		...
		<li> 
			<label for="comment"><?php _e("Comment ", "site5framework"); ?></label> 
			<textarea name="comment" id="comment" tabindex="4"></textarea>
		</li>
	
		<li>
			<label></label>
			<input name="submit" type="submit" id="submitcomment" class="submitbutton" tabindex="5" value="<?php _e("COMMENT", "site5framework"); ?>" />
		</li>
