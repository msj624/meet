	...
	<body id="wp-admin" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
		...
		function themify_insert_shortcode(type) {
			...
			switch(type){
				...
				case 'twitter':
					sc_content = '[' + type + ' ' + themify_scparams(Array('username', 'show_count', 'show_timestamp', 'show_follow', 'follow_text'), type) + ']';
				break;
				
				case 'post_slider':
					sc_content = '[' + type + ' ' + themify_scparams( Array( 'limit', 'category', 'image', 'image_w', 'image_h', 'image_size', 'title', 'display', 'post_meta', 'more_text', 'visible', 'scroll', 'auto', 'wrap', 'speed', 'slider_nav', 'width', 'height', 'class', 'order', 'orderby' ), type ) + ']';
				break;
