...
<div class="themify_builder themify_builder_admin clearfix">
	...
	<div class="themify_builder_module_panel clearfix">
		...
		<div class="<?php echo esc_attr($class); ?>" data-module-name="<?php echo $module_key; ?>">
			<strong class="module_name"><?php echo esc_html( $module_settings['name'] ); ?></strong>
			<a href="#" class="add_module" data-module-name="<?php echo $module_key; ?>"><?php _e('Add', 'themify') ?></a>
		</div>
		<!-- /module -->
		<?php endforeach; ?>
	</div>
			...
			<div class="themify_builder_row_content">
				...
				<div class="themify_builder_col <?php echo $col['grid_class']; ?>">
					<div class="themify_module_holder">
						...
						<div class="themify_builder_module module-<?php echo $mod['mod_name']; ?> active_module" data-mod-name="<?php echo $mod['mod_name']; ?>">
							<div class="module_menu">
								<div class="menu_icon">
								</div>
								<ul class="themify_builder_dropdown">
									<li><a href="#" class="themify_module_options" data-module-name="<?php echo $mod['mod_name']; ?>"><?php _e('Options', 'themify') ?></a></li>
