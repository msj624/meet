...
/***************************************************************************/
	...
	function themify_get_skin_stylesheet() {
		$data = themify_get_data();
		if( $data['skin'] != '' ) {
			wp_enqueue_style('themify-skin', themify_https_esc($data['skin']), array('theme-style'));
		}
	}
...
if(!function_exists('themify_image_url')) {
	 ...
	 * @param string Text to use for (more...)
	 * @param int Optional. Strip teaser content before the more text
