<div id="footer_wrap" class="row">
    <div id="footer" class="span12 center none">
        ...
        <div id="footer_base">
            ...
            <p id="credit"><a href="http://www.nimbusthemes.com/wordpress-themes/opulus-sombre/" rel="nofollow">Opulus Sombre</a> <?php _e('by Nimbus Themes', 'nimbus_opulus_sombre'); ?>  | <?php _e('Powered by', 'nimbus_opulus_sombre'); ?> <a href="http://wordpress.org"><?php _e('WordPress', 'nimbus_opulus_sombre'); ?></a></p>
        </div>		
    </div>
</div>
<?php wp_footer(); ?>		
