...
<div class="breadcrumb">Posted on <?php echo get_the_date(); ?> / Posted by <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author(); ?></a> <a class="btn btn-info pull-right btn-more" href="<?php the_permalink();?>">read more <i class="icon icon-chevron-right icon-white"></i></a></div>
</div> 
</div> 
<?php endwhile; ?>               
